...
class MarilynToneApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Marilyn Tone - Professional Speech Synthesizer")
    ...
    def setup_sidebar(self, parent):
        ...
        preview_btn = ttk.Button(
            top_sidebar, text="ПРОСЛУШАТЬ ГОЛОС", style='Secondary.TButton',
        ...
        self.stop_btn = ttk.Button(
            bottom_sidebar, text="ОСТАНОВИТЬ ГОЛОС", style='Secondary.TButton',
    ...
    def setup_main_area(self, parent):
        ...
        self.text_input = scrolledtext.ScrolledText(
            text_container, bg="#252525", fg=self.text_color, font=self.mono_font,
        ...
        speed_column.pack(side="left", fill="both", expand=True, padx=(0, 15))
        ...
        self.pitch_shift_scale = tk.Scale(
        ...
        self.volume_adjust_scale = tk.Scale(
            effects_frame, from_=-20, to=20, orient=tk.HORIZONTAL,
            bg=self.card_color, fg=self.text_color, highlightthickness=0,
            troughcolor="#252525", activebackground=self.accent_color,
            sliderlength=20, length=180, showvalue=False
        )
